...
<body>
    ...
    <div class="container mx-auto">
        ...
        <form class="mt-10 mr-96 ml-96" action="" method="POST">
            <div class="mb-6">
                <label for="codigo" class="mb-2 block text-sm font-medium text-gray-900 dark:text-gray-300">
                    Comentar artículo:
                </label>

                <textarea rows="4" cols="50" name="codigo" class="mb-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                </textarea>
            </div>
