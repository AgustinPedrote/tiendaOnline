                    ...
                    <?php foreach ($sent as $fila) : ?>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 text-center">
                                ...
                                <a href="/comentarios_editar.php?id_art=<?= hh($fila['articulo_id']) ?>&id_us=<?= hh($fila['usuario_id']) ?>&hora=<?= hh($fila['created_at']) ?>&comentario=<?= hh($fila['comentario']) ?>" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 mr-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-900">
                                    Editar
                                </a>
                                <!-- Borrar -->
